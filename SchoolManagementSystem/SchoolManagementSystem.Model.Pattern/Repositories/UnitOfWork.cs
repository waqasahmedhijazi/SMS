...
namespace SchoolManagementSystem.Model.Pattern.Repositories
{
    ...
    {
        private DBSchoolManagementSystemEntities _dbContext;
        private BaseRepository<TblParent> _parents;
        private BaseRepository<TblGenMaritalStatu> _maritalStaut;
        ...
        public UnitOfWork()
        {
            _dbContext = new DBSchoolManagementSystemEntities();
        ...
        public IBaseRepository<TblGenMaritalStatu> MaritalStaut
        {
            get
            {
                return _maritalStaut ??
                    (_maritalStaut = new BaseRepository<TblGenMaritalStatu>(_dbContext));
            }
        }
