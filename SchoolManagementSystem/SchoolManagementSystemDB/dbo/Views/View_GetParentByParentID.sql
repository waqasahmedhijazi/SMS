...
AS
SELECT        dbo.TblParent.ParentID, dbo.TblParent.FirstName, dbo.TblParent.LastName, dbo.TblParent.Email, dbo.TblGenMaritalStatus.MaritalStatus, dbo.TblGenGender.Gender, dbo.TblParent.CNICNumber, 
                         ...
                         dbo.TblParent.ZipCode, dbo.TblParent.CellNumber, dbo.TblParent.TelephoneRes, dbo.TblParent.TelephoneOffice, dbo.TblParent.JobDetail, dbo.TblParent.ProfilePicture, dbo.TblParent.IsActive,convert(varchar(10), dbo.TblParent.CreatedDate,101) as CreatedDate, 
...
FROM            dbo.TblParent LEFT JOIN
                         ...
                         dbo.TblGenMaritalStatus ON dbo.TblParent.MaritalStatusID = dbo.TblGenMaritalStatus.MaritalStatusID LEFT JOIN
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "TblGenGender"
            ...
            TopColumn = 0
         End
         Begin Table = "TblGenMaritalStatus"
            Begin Extent = 
               Top = 7
               Left = 1033
               Bottom = 170
